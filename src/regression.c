...
void linear_regression(double x_values[], double y_values[], int n)
{
    ...
    double sum_xi = 0; double sum_yi = 0;
    double sum_xi_times_yi = 0; double sum_xi_pow = 0; double sum_yi_pow = 0;
...
void log_regression(double x_values[], double y_values[], int n)
{
    int id = 2;
    double coef_a, coef_b, coef_r, R_square, std_err_of_reg, aux_up, aux_down;
    double sum_ln_xi = 0; double sum_yi = 0;
    double sum_lnxi_times_yi = 0; double sum_ln_xi_pow = 0;
...
void power_regression(double x_values[], double y_values[], int n)
{
    int id = 3;
    double coef_a, coef_b, coef_r, R_square, std_err_of_reg, aux_up, aux_down;
    double sum_ln_xi = 0; double sum_yi = 0; double sum_ln_yi = 0;
    double sum_lnxi_times_lnyi = 0; double sum_ln_xi_pow = 0;
...
void ab_exponential_regression(double x_values[], double y_values[], int n)
{
    int id = 4;
    double coef_a, coef_b, coef_r, R_square, std_err_of_reg, aux_up, aux_down;
    double sum_xi = 0; double sum_ln_yi = 0; double sum_yi = 0;
    double sum_xi_times_lnyi = 0; double sum_xi_pow = 0;
...
void hyperbolic_regression(double x_values[], double y_values[], int n)
{
    ...
    double coef_a, coef_b, coef_r, R_square, std_err_of_reg, aux_up, aux_down;
    double sum_xi = 0; double sum_yi = 0;
    double sum_yi_div_xi = 0; double sum_xi_pow = 0;
...
void exponential_regression(double x_values[], double y_values[], int n)
{
    int id = 6;
    double coef_a, coef_b, coef_r, R_square, std_err_of_reg, aux_up, aux_down;
    double sum_xi = 0; double sum_yi = 0; double sum_lnyi = 0;
    double sum_lnyi_times_xi = 0; double sum_xi_pow = 0;
